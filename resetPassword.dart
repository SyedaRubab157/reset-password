...
class _reset_passwordState extends State<reset_password> {
          ...
          child: Padding(
            ...
            child: Column(children: [
              ...
              TextFormField(
                ...
                cursorWidth: 4.8,
                cursorColor: Colors.white30,
                cursorRadius: const Radius.elliptical(60, 30),
                style: const TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.w800,
                    wordSpacing: 0.5),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                    animationDuration: const Duration(seconds: 08),
                    primary: const Color.fromRGBO(244, 175, 27, 100),
  ...
  void reset_password(TextEditingController email, TextEditingController currentPassword, TextEditingController newPassword)
  {
